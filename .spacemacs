...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (setq-default dotspacemacs-themes '(material-light
                                      spacemacs-light
                                      rebecca
                                      spolsky
                                      leuven
